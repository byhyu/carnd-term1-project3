        ...
        for offset in range(0, num_samples, batch_size):
            ...
            for batch_sample in batch_samples:
                for i in range(3):
                    ...
                    images.extend((image, image_bright,image_lr))
                ...
                if right_angle<-1:
                    right_angle=-1
                angles.extend((center_angle,center_angle,-center_angle,left_angle,left_angle,-left_angle,right_angle,right_angle,-right_angle))
...
history_object=model.fit_generator(train_generator,
                    samples_per_epoch=9*len(train_samples),
